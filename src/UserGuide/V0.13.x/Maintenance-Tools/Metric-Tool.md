...
Method two:  You can visit Grafana Dashboard official website, click here to download [Apache IoTDB Dashboard](https://grafana.com/api/plugins/apache-iotdb-datasource/versions/1.0.0/download).
